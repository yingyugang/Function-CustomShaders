...
void surf (Input IN, inout SurfaceOutput o) {
	...
	fixed4 tex1 = tex2D(_Stone,IN.uv_MainTex);
	...
	if (ClipAmount <0)
	{
	 ...
	 else
	 {
		...
		if (ClipAmount < _StartAmount)
		{
			...
			o.Albedo  = lerp(tex.rgb,tex1.rgb,ClipAmount/_StartAmount);
			
//			o.Albedo  = lerp(tex.rgb,tex1.rgb,ClipAmount/_StartAmount)/(1 - _Illuminate);
